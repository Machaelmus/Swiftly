...
Revision ID: e7439923ac1c
Revises: 
Create Date: 2021-11-23 12:28:17.580743
...
def upgrade():
    ...
    sa.Column('coverPhotoUrl', sa.Text(), nullable=False),
    ...
    sa.Column('timeOfReply', sa.DateTime(), nullable=False),
